export default function CGU() {
  return (
    <div className="modal_cgu_content">
      ...
      <div className="utilisation_service">
        ...
        <p>
          2.3. Compte Utilisateur : Vous pouvez être amené à créer un compte
          utilisateur pour accéder à certaines fonctionnalités du Service. Vous
      ...
      <div className="propriete_intellectuelle">
        ...
        <div className="modification">
          ...
          <p>
            ...
            Service. Il est de votre responsabilité de consulter régulièrement
        ...
        <p>
          ...
          concernant ces CGU, veuillez nous contacter à codinginshape@gmail.com
        </p>
      </div>
    </div>
  );
